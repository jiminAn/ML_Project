...
- [텍스트 벡터화 방법 별 성능 분석 진행](##2-텍스트-벡터화-방법-별-성능-분석-진행)

  - Word2Vec, WordCount, TF-IDF

- [이진분류기 모델 별 성능 분석 진행](##3-이진분류기-모델-별-성능-분석-진행)
...
|     Member     |                       역할                       | 책임 |
| :---------: | :----------------------------------------------: | :---------------------------------: |
| [ElPlaguister(이승민)](https://github.com/ElPlaguister) : 팀장 | 팀장, | 크롤러, 데이터 라벨링 |
|  [jiminAn(안지민)](https://github.com/jiminAn)   | 데이터 라벨링, 텍스트 임베딩 테스트, 모델 학습 | 데이터 라벨링, 텍스트 임베딩 테스트, 모델 학습 |
|    [wooseok(김우석)](https://github.com/woosook0127)   | 데이터 라벨링, 모델 학습 및 튜닝 | 데이터 라벨링, 모델 학습 및 튜닝 |
| [comeeasy(김준호)](https://github.com/comeeasy) | 데이터 전처리, GUI 제작 | 데이터 전처리, GUI 제작 |
